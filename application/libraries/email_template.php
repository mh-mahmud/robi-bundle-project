							...
							<td colspan="3" align="right">
								<table align="right" style="font-family:tahoma; font-size:12px;">
									<tr>
										...
										<td width="5">&nbsp;</td>
										<td><a style="text-decoration:none;" href="https://twitter.com/bundle">Follow Us</a></td>
										<td><img src="{$site_url}global/img/icon_twitter.png" alt="" /></td>
										<td width="5">&nbsp;</td>
										<td><a style="text-decoration:none;" href="https://www.facebook.com/bundle">Like Us</a></td>
