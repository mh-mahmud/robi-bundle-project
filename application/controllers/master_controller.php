...
class Master_controller extends CI_Controller {
	...
	*/
	...
	function create_user($data=null){
		...
		(USER_ID, USER_NAME, USER_EMAIL, USER_PHONE, USER_PASSWORD, ROLE_ID, CREATED_BY, CREATED_DATE, STATUS)
		VALUES
    ...
    if ($criteria == 'page') {
		...
		FROM VIEW_USER
		LEFT JOIN TBL_BUNDLE_ROLE ON TBL_BUNDLE_ROLE.ROLE_ID = VIEW_USER.ROLE_ID
		";
