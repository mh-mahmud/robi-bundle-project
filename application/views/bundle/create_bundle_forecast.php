...
<body>
	<div id="wrapper">
		...
		<div id="page_create_bundle_forecast" class="main_container page_identifier">
			<div class="page_caption">Create Bundle Forecast</div>
			<div class="page_body">
	        ...
	        <div class="left_section">
					...
					<div class="right_section">
		               ...
		               <select id="type" name="type" class="input_s input_style" required>
							...
							<tr>
								<td>
									<div class="form_label">Sale Date <span class="stitle">(assumption)</span></div>
									<div>
										<input type="text" class="input_s input_style date_picker" readonly="readonly" id="sale_date" name="sale_date" value="<?php echo set_value('sale_date'); ?>" required />
										<span class="fred"><?php echo form_error('sale_date'); ?></span>
									</div>
								</td>
							</tr>
							<tr>
								<td>
									<div class="form_label">Sale Quantity <span class="stitle">(assumption)</span></div>
									<div>
										<input type="text" class="input_s input_style" id="sale_quantity" name="sale_quantity" value="<?php echo set_value('sale_quantity'); ?>" data-parsley-type="digits"  />
										<span class="fred"><?php echo form_error('sale_quantity'); ?></span>
									</div>
								</td>
							</tr>
						</table>
