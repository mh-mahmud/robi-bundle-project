		...
		<div id="printArea">
			...
			<table class="table" width="100%" border="1" cellpadding="0" cellspacing="0">
					...
					<tr>
						...
						<td class="text-center" align="center"><?php echo $v->EMI_INTEREST; ?>%</td>
						...
						<td class="text-center" align="center"><?php echo $this->customcache->user_maker($v->UPDATED_BY,'USER_NAME'); ?></td>
						<td class="text-center" align="center"><?php echo $this->webspice->formatted_date($v->UPDATED_DATE); ?></td>
