...
<body>
	<div id="wrapper">
		...
		<div id="page_bundle_details" class="main_container page_identifier">
			<div class="page_caption">Bundle Details</div>
			<div class="page_body table-responsive">

				<table style="width:auto;">
					<tr>
						<td colspan="10">
							<a class="btn_gray" href="<?php echo $url_prefix; ?>details_bundle/print" target="_blank">Print</a>
							<a class="btn_gray" href="<?php echo $url_prefix; ?>details_bundle/csv" target="_blank">Export</a>
						</td>
					</tr>
				</table>
