...
<body>
	<div id="wrapper">
		...
		<div id="page_individual_jv" class="main_container page_identifier">
			<div class="page_caption">Individual JV for FV Allocation and Revenue Deferment</div>
			<div class="page_body">
					...
					<form id="frm_filter" method="post" action="" target="_blank" data-parsley-validate>
						...
						<table>
		              	...
		              	<select id="" class="input_m input_style" name="report_type" required>
		              		<option value="">Select One</option>
		              		<option value="earned">FV Allocation</option>
		              		<option value="unearned">Revenue Deferment</option>
		              	</select>
									</div>
								</td>
							</tr>
