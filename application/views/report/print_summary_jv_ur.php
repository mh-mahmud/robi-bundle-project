...
$total_column = 4;
$report_name = 'Summary JV for Revenue Deferment';
...
<html lang="en">
  ...
  <body>
		...
		<div id="printArea">
			...
			$grand_total_revenue += $total_remaining_interest;
			#dd($unearned_revenue);
			?>
			...
			<table class="table" border="1" cellpadding="0" cellspacing="0" style="width:auto;" align="center">
				...
				<tr>
					...
					<td class="text-center" align="center"><?php echo $this->webspice->tk(round($unearned_revenue[$vs1->SERVICE_ID],2)); ?></td>
				...
				<tr>
					...
					<td class="text-center" align="center"><?php echo $this->webspice->tk(round($total_remaining_interest,2)); ?></td>
					<td class="text-center" align="center">&nbsp;</td>
				</tr>
