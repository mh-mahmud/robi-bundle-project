...
<body>
	<div id="wrapper">
		...
		<div id="page_fv_summery" class="main_container page_identifier">
			<div class="page_caption">FV Allocation Summary Report</div>
			<div class="page_body">
				...
				<div class="left_section">
					...
					<form id="frm_filter" method="post" action="" target="_blank" data-parsley-validate>
						...
						<table width="100%">
							<tr>
								<td>
									<div class="form_label">Summary Month*</div>
									<div>
		               <input type="text" class="input_style input_full month_picker" readonly="readonly" name="report_month" required/>
									</div>
								</td>
							</tr>
							<tr>
