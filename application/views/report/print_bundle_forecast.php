...
$report_name = 'Bundle Forecast Report';
...
<html lang="en">
  ...
  <body>
		...
		<div id="printArea">
			...
			<div class="text-center"><h3>FV Allocation</h3></div>
			...
			<br /><br />
			<?php
			# generate bundle sale
			$get_bundle_sale[0] = new stdClass();
			$get_bundle_sale[0]->BUNDLE_ID = $get_bundle[0]->BUNDLE_ID;
			$get_bundle_sale[0]->INVOICE_DATE = $get_bundle[0]->SALE_DATE;
			$get_bundle_sale[0]->MATERIAL_CODE = $get_bundle[0]->MATERIAL_CODE;
			$get_bundle_sale[0]->MATERIAL_NAME = $get_bundle[0]->MATERIAL_NAME;
			$get_bundle_sale[0]->QUANTITY = $get_bundle[0]->SALE_QUANTITY;
			?>
			<div class="text-center"><h3>Details of Forecasted Bundle Revenue</h3></div>
			...
			<div style="overflow:auto;">
				<table class="table table-bordered table-striped" align="center" style="width:auto;">
					...
					<!--SD-->
					<tr>
						<td style="vertical-align:middle; font-weight:bold;">SD</td>
						<?php 
						$temp_year = $start_year;
						$temp_month = $start_month;
						?>
					...
					<tr>
						...
						<?php for($i=$start_month; $i<($start_month+$month_count); $i++): ?>
							...
							<td style="font-weight:bold;" align="center">
								...
								echo $this->webspice->tk(round($grand_total, 2)); 
								?>
							</td>
