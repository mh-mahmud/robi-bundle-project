<div id="header_container">
	<div class="header_bg">
		<div class="my_container">
			<div class="left_part">
				<div class="caption fsecond">&nbsp;<?php echo $this->webspice->settings()->site_title; ?></div>
			</div>
							...
							if( $is_permitted ){
								...
								foreach($get_permission as $pk1=>$pv1){
									if( $this->webspice->permission_verify($pv1->PERMISSION_NAME, true) && $pv1->MENU_NAME != $menu_name ){
										...
										echo '<li><a href="'.$url_prefix.$pv1->ROUTE_NAME.'">'.str_replace(array('Jv','Fv','_','jv','fv'),array('JV','FV',' ','JV','FV'), ucwords($pv1->MENU_NAME)).'</a></li>';
