...
insert  into `TBL_BUNDLE`(`BUNDLE_ID`,`BUNDLE_NAME`,`GL_CODE`,`TYPE`,`EMI_MONTH`,`CREATED_BY`,`CREATED_DATE`,`UPDATED_BY`,`UPDATED_DATE`,`STATUS`) values (1,'iPhone6 eid dhamaka','111333','in_cash',0,1,'2015-09-16 12:11:17',1,'2015-09-17 01:37:40',2),(2,'Samsung S6 Mega Offer','222333','emi',0,1,'2015-09-17 01:24:22',1,'2015-09-17 01:38:20',2);
...
insert  into `TBL_BUNDLE_ITEM`(`ID`,`BUNDLE_ID`,`BUNDLE_ITEM_ID`,`UNIT_ID`,`TYPE`,`LOOP_DAYS`,`QUANTITY`,`UNIT_PRICE`,`SUB_GL`,`STATUS`) values (1,1,1,4,'once',0,1,6700,'11',7),(2,1,2,5,'loop',3,300,0.3,'0',7),(3,1,3,5,'loop',6,500,0.5,'0',7),(4,2,1,4,'once',0,1,8700,'0',7),(5,2,2,5,'loop',5,500,0.3,'0',7),(6,2,3,5,'loop',6,1200,0.59,'0',7);
...
insert  into `TBL_BUNDLE_SALE`(`SALE_ID`,`BUNDLE_ID`,`QUANTITY`,`CREATED_BY`,`CREATED_DATE`,`REFERENCE`,`STATUS`) values (1,1,1,1,'2015-09-16 00:00:00','006',7),(2,1,2,1,'2015-09-17 00:00:00','006',7),(3,1,3,1,'2015-09-18 00:00:00','006',7),(4,1,4,9,'2015-09-19 00:00:00','006',7),(5,2,1,9,'2015-02-20 00:00:00','007',7),(6,2,2,9,'2015-09-21 00:00:00','007',7),(7,2,3,9,'2015-09-22 00:00:00','007',7),(8,2,4,1,'2015-09-23 00:00:00','007',7);
